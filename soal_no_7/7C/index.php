        ...
        <div class="container">
                            ...
                            <form method="POST" action="db/add_data.php">
                                ...
                                <div class="form-group">
                                    <select class="form-control" id="kategori" name="kategori">
                                        ...
                                        <?php 
                                        $kategori = NEW crudsimple();
                                        $kategori->connect();
                                        $kategori->sql("SELECT * FROM kategori");
                                        while ($data = $kategori->collectData()) {
                                            echo "<option value=".$data['id']."> ".$data['salary']."</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
            ...
            <table class="table table-bordered flex">
                ...
                <?php 
                    $data = NEW crudsimple();
                    $data->connect();
                    $data->sql("SELECT name.nama, work.name, kategori.salary FROM name JOIN work ON name.id_work = work.id JOIN kategori ON name.id_salary = kategori.id");
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Work..."  value="<?php echo $result['name']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Salary..."  value="<?php echo $result['salary']; ?>">
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
